...
export default function Home() {
    return (
        <>
            ...
            <div>
                <h1>Zašto vježbati na reformeru?</h1>
                <p>
                    Vježbanje na reformeru pruža mnoge prednosti, uključujući poboljšanje držanja, jačanje mišića, povećanje fleksibilnosti i smanjenje stresa. Također pomaže u rehabilitaciji ozljeda i poboljšanju tjelesne svijesti. Reformer vježbe su prilagodljive različitim razinama tjelesne spremnosti, što ih čini pogodnima za svakoga, od početnika do iskusnih vježbača.   No krenimo od od samog početka od prije stotinu godina...
                </p>
            </div>
            <div>
                <h1>Kontrologija </h1>
